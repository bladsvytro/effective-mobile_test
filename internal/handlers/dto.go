...
type CreateSubscriptionRequest struct {
	...
	Price       int       `json:"price" validate:"required,min=1" example:"400"`
	UserID      uuid.UUID `json:"user_id" validate:"required" example:"60601fee-2bf1-4721-ae6f-7636e79a0cba"`
	StartDate   string    `json:"start_date" validate:"required" example:"07-2025"` // формат MM-YYYY
...
type UpdateSubscriptionRequest struct {
	...
	Price       *int    `json:"price,omitempty" validate:"omitempty,min=1" example:"500"`
...
type TotalPriceRequest struct {
	StartDate   string     `form:"start_date" validate:"required" example:"01-2025"`
	EndDate     string     `form:"end_date" validate:"required" example:"12-2025"`
